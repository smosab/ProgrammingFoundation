...
def fun_with_ids
  a_outer = 42 #object_id = 85
  b_outer = "forty two" #object_id = 70347500499380
  c_outer = [42] #object_id =
  d_outer = c_outer[0] #4  #object_id = 85 - why does this variable have the same object id as a_outer?

  a_outer_id = a_outer.object_id #object_id =
  b_outer_id = b_outer.object_id #object_id = 140695000998761
  c_outer_id = c_outer.object_id #object_id =
  d_outer_id = d_outer.object_id #object_id =
  ...
  1.times do
    ...
    b_outer_inner_id = b_outer.object_id # 140695000998761
    ...
    a_outer = 22
    b_outer = "thirty three" #70347512642680
    c_outer = [44]
    d_outer = c_outer[0]
    ...
    # binding.pry
    a_inner = a_outer
    b_inner = b_outer #70347512642680
    c_inner = c_outer
    d_inner = c_inner[0]
    # binding.pry
    a_inner_id = a_inner.object_id
    b_inner_id = b_inner.object_id #140695025285361
